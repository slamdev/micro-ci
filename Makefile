...
INFRA_MODULES := infra/namespace-configuration $(shell find infra -type d -mindepth 1 -maxdepth 1 | grep -v 'namespace-configuration')
SERVICE_MODULES := $(shell find services -type d -mindepth 1 -maxdepth 1)
